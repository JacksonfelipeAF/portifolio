  ...
  const tecnologias = [
    {
      ...
      uso: "Componentes reutilizáveis, estado global, hooks",
    },
    {
      nome: "TypeScript",
      icone: "",
      categoria: "Frontend",
      descricao:
        "Superset do JavaScript que adiciona tipagem estática para código mais seguro.",
      uso: "Interfaces, tipos customizados, generics",
    },
    {
      nome: "JavaScript",
      icone: "",
      categoria: "Frontend",
      descricao:
        "Linguagem de programação essencial para desenvolvimento web moderno.",
      uso: "DOM manipulation, APIs, ES6+, async/await",
    },
    {
      nome: "HTML",
      icone: "",
      categoria: "Frontend",
      descricao: "Estrutura fundamental para criar conteúdo web semântico.",
      uso: "Semantic HTML5, forms, accessibility",
    },
    {
      nome: "CSS",
      icone: "",
      categoria: "Frontend",
      descricao: "Estilização e design visual para páginas web.",
      uso: "Flexbox, Grid, animations, responsive design",
    },
    {
      nome: "Tailwind CSS",
      icone: "",
      ...
      uso: "Design responsivo, temas customizados, componentes",
    },
    {
      nome: "Vite",
      icone: "",
      categoria: "Frontend",
      descricao:
        "Build tool extremamente rápido para desenvolvimento web moderno.",
      uso: "Hot reload, otimização de build, plugins",
    },
    {
      nome: "Next.js",
      icone: "",
      categoria: "Frontend",
      descricao: "Framework React com renderização server-side e estática.",
      uso: "SSR, SSG, API routes, otimização automática",
    },
    {
      nome: "Vue.js",
      icone: "",
      categoria: "Frontend",
      descricao:
        "Framework progressivo JavaScript para construir interfaces de usuário.",
      uso: "Componentes, reatividade, Vue Router",
    },
    {
      nome: "Vuetify",
      icone: "",
      categoria: "Frontend",
      descricao:
        "Biblioteca de componentes UI para Vue.js baseada em Material Design.",
      uso: "Grid system, formulários, temas",
    },
    {
      nome: "Node.js",
      icone: "",
      categoria: "Backend",
      descricao: "Runtime JavaScript para executar código no servidor.",
      uso: "APIs REST, microserviços, streaming",
    },
    {
      nome: "NestJS",
      icone: "",
      categoria: "Backend",
      descricao:
        "Framework TypeScript para construir aplicações server-side escaláveis.",
      uso: "Modules, decorators, dependency injection, microservices",
    },
    {
      nome: "Express.js",
      icone: "",
      categoria: "Backend",
      descricao:
        "Framework minimalista para criar APIs e aplicações web no Node.js.",
      uso: "Rotas, middleware, autenticação",
    },
    {
      nome: "GraphQL",
      icone: "",
      categoria: "Backend",
      descricao: "Linguagem de query para APIs mais eficientes e flexíveis.",
      uso: "Schema, resolvers, subscriptions, Apollo Client",
    },
    {
      nome: "MongoDB",
      icone: "",
      ...
      uso: "CRUD, agregação, indexes",
    },
    {
      nome: "Mongoose",
      icone: "",
      categoria: "Backend",
      descricao: "ODM para MongoDB e Node.js com schema validation.",
      uso: "Models, schemas, population",
    },
    {
      nome: "PostgreSQL",
      icone: "",
      categoria: "Backend",
      descricao: "Banco de dados relacional poderoso e extensível.",
      uso: "ACID, indexes, JSONB, window functions",
    },
    {
      nome: "bcrypt",
      icone: "",
      categoria: "Backend",
      descricao: "Biblioteca para hashing de senhas de forma segura.",
      uso: "Hashing, salt, comparação de senhas",
    },
    {
      nome: "Docker",
      icone: "",
      categoria: "DevOps",
      descricao: "Plataforma para containerização de aplicações.",
      uso: "Containers, Docker Compose, orquestração",
    },
    {
      nome: "Git",
      icone: "",
      ...
      uso: "Branches, merges, pull requests, CI/CD",
    },
    {
      nome: "nodemailer",
      icone: "",
      categoria: "Backend",
      descricao: "Módulo para enviar emails a partir de aplicações Node.js.",
      uso: "Templates, anexos, SMTP",
    },
    {
      nome: "cors",
      icone: "",
      categoria: "Backend",
      descricao: "Middleware para habilitar CORS em APIs Express.",
      uso: "Origins permitidas, headers customizados",
    },
    {
      nome: "dotenv",
      icone: "",
      categoria: "Backend",
      descricao: "Módulo para gerenciar variáveis de ambiente.",
      uso: "Configuração, secrets, ambiente",
    },
    {
      nome: "APIs REST",
      icone: "",
      categoria: "Backend",
      descricao: "Arquitetura para criar APIs escaláveis e padronizadas.",
      uso: "CRUD, status codes, versionamento",
    },
  ];
  ...
  return (
    <section className="py-24 px-6 relative scroll-snap-start">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-12">
          <h3 className="text-3xl md:text-4xl font-bold mb-8 text-center bg-gradient-to-r from-stone-800 via-amber-700 to-stone-800 bg-clip-text text-transparent animate-gradient opacity-0 animate-fade-in-delay-3 bg-size-200">
          ...
          <div className="grid grid-cols-3 md:grid-cols-6 gap-0 max-w-4xl mx-auto relative">
            {tecnologias.map((tech, i) => (
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-r from-transparent via-amber-400/40 via-stone-400/30 to-transparent transform skew-x-12 scale-x-150 origin-left opacity-0 group-hover:opacity-100 transition-all duration-700 blur-sm"></div>
                ...
                <div
                  className="comet-glow relative bg-gradient-to-br from-stone-200/80 to-stone-300/60 backdrop-blur-sm p-2 transform hover:scale-115 hover:rotate-12 transition-all duration-500 opacity-0 animate-fade-in-delay-4 cursor-pointer overflow-hidden border border-stone-400/20 hover:border-amber-500/40 shadow-lg hover:shadow-amber-400/20"
                  style={{
                    clipPath:
                      "polygon(30% 0%, 70% 0%, 100% 30%, 100% 70%, 70% 100%, 30% 100%, 0% 70%, 0% 30%)",
                    aspectRatio: "1",
                    boxShadow: "inset 0 0 10px rgba(251, 191, 36, 0.1)",
                  }}
                ...
                >
                  ...
                  <div className="flex flex-col items-center justify-center h-full text-center relative z-10">
                    <div className="text-lg mb-1 group-hover:scale-125 transition-all duration-300 group-hover:text-amber-600 group-hover:drop-shadow-lg">
                      {tech.icone}
                    </div>
                    <div className="text-xs font-bold text-stone-800 leading-tight group-hover:text-stone-900 group-hover:tracking-wide transition-all duration-300">
                      {tech.nome}
                    </div>
                  </div>
                </div>
      ...
      <div className="bg-gradient-to-br from-amber-100/50 via-stone-200/50 to-amber-200/50 p-8 rounded-2xl border border-amber-300/50 shadow-xl opacity-0 animate-fade-in-delay-5">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {[
            ...
            <div
              key={i}
              className="bg-stone-100/70 p-6 rounded-xl text-center transition-all duration-300 cursor-pointer border border-stone-300/50 hover:border-stone-400/50 hover:shadow-lg"
            >
