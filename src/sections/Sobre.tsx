      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-gradient-to-br from-amber-100/50 via-stone-200/50 to-amber-200/50 p-8 rounded-2xl border border-amber-300/50 shadow-xl opacity-0 animate-fade-in-delay-5">
          ...
          <p className="text-center text-stone-700 mb-8 max-w-3xl mx-auto leading-relaxed text-lg">
            Uma jornada digital que transforma código em arte. Este portfolio
            representa a evolução constante no desenvolvimento web, combinando
            design inovador com performance excepcional. Cada elemento foi
            cuidadosamente criado para proporcionar uma experiência única e
            memorável.
          </p>
            ...
            {[
              {
                nome: "React",
                icone: "⚛️",
                desc: "Estrutura reativa e modular",
              },
              {
                nome: "TypeScript",
                icone: "📘",
                desc: "Tipagem segura e robusta",
              },
              {
                nome: "Tailwind CSS",
                icone: "🎯",
                desc: "Design system moderno",
              },
              ...
              >
                <div
                  className="text-2xl mb-3 animate-float-icon"
                ...
                <div className="text-xs text-stone-500 mt-2">{tech.desc}</div>
              </div>
            ))}
          </div>
        </div>
